            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="animate-on-scroll">
                        <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-brand-darkBlue">About
                            Precision Drywall</h2>
                        <div className="w-20 h-1 bg-brand-blue mb-6"></div>
                        <p className="text-lg text-gray-600 mb-6">
                            Precision Drywall is a professional drywall company proudly serving Livonia, Michigan and
                            surrounding communities. We specialize in providing high-quality drywall installation,
                            repair, and finishing services for both residential and commercial clients.
                        </p>
